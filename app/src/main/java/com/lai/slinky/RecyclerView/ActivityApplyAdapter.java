 ...
 */
public class ActivityApplyAdapter extends RecyclerView.Adapter<ActivityApplyAdapter.MyViewHolder> {
    //用于为社团审批RecyclerView提供适配器

    private ArrayList<activityy> mDatas;
    private LayoutInflater mInflater;
    private ItemClickListener ClickListener;

    public ActivityApplyAdapter(Context context, ArrayList<activityy> mDatas) {
        this.mDatas = mDatas;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        activityy tdata = mDatas.get(position);
        holder.tvApplyTitle.setText(tdata.getActName());
...
//            });
    ...
    //设置adapter接口
    public ActivityApplyAdapter setClickListener(ItemClickListener ClickListener){
