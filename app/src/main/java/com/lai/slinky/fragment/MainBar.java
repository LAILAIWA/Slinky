...
public class MainBar extends RelativeLayout implements View.OnClickListener {
    //自定义布局
    ...
    public MainBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        initTwoType(context, attrs);//第二种初始化
    ...
    private void iniView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.mainbar, this, true);
    ...
    private void initTwoType(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MainBar);
        if (null != typedArray) {
            Drawable leftDrawable = typedArray.getDrawable(R.styleable.MainBar_leftImage);
            leftImage.setImageDrawable(leftDrawable);

            boolean leftImageVisible = typedArray.getBoolean(R.styleable.MainBar_leftImageVisiable, false);
            if (leftImageVisible) {
