...
//        initDatas();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        isInitialized = true ;
        view = iniView(inflater, container, savedInstanceState);
//        initDatas();
        return view;
    }
...
//    }
    ...
    protected abstract View iniView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState);
